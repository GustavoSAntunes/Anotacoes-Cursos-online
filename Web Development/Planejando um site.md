...
Caso o seu site seja [[Media Queries#Mobile First|Mobile First]], outra configuração universal muito usada é a [border-box], fazendo com que a borda seja inclusa no cálculo do tamanho:
...
Formatar o texto usando [b], [strong], etc... ([[Tags#Formatação de Texto|Formatação de texto]])
...
# Quarto passo: Alinhamento

É **MUITO IMPORTANTE** tentar organizar o layout e fazer ele **SE ALINHAR CORRETAMENTE**. Antes de perder muito tempo decorando o site, faça ele se alinhar CORRETAMENTE. Seguir esse passo antes das animações, cores, paddings e etc. vai te salvar MUITO TEMPO.
