...
- **% (porcentagem):** O tamanho é definido em relação ao elemento pai. Por exemplo, `width: 50%;` significa que o elemento terá metade da largura do seu contêiner. Útil para mudar o tamanho de elementos em **contêineres**.
...
- **fr**: fractions (frações), usadas em Grid. Elas são usadas nos [[Grid Layout#Propriedades para container Grid|templates]] para que possamos manipular melhor a divisão dos tamanhos de cada item.
