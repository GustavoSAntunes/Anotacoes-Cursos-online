...
Um exemplo de uso de iframes são os vídeos, para não pesar o site hospedando um ou mais vídeos, incorporamos o vídeo do youtube para o nosso site usando iframes.
Não é preciso escrever nenhum código, a função "Incorporar" do youtube já faz isso para nós.
